...
<h3 class="fm_headingTitle"><?php _e('Персональные настройки', 'wp-file-manager'); ?></h3>
...
<tr>
<th><?php _e('Корневой Путь', 'wp-file-manager'); ?></th>
<td>
...
<p class="description mb15"><?php _e('Корневой путь файлового менеджера вы можете изменить по своему выбору.', 'wp-file-manager'); ?></p>
<p>По умолчанию: <code><?php echo $path; ?></code></p>
<p style="color:#F00" class="description mb15"><?php _e('Пожалуйста, будьте внимательны при изменении, неправильный путь может привести к тому, что плагин файлового менеджера будет не работать.', 'file-manager-advanced'); ?></p>
</td>
</tr>
<tr>
<th><?php _e('Включить корзину?', 'wp-file-manager'); ?></th>
<td>
...
<p class="description mb15"><?php _e('После включения корзины Ваши файлы перейдут в папку корзины.', 'wp-file-manager'); ?>
</p>
</td>
</tr>
<tr>
<th><?php _e('Включить загрузку файлов в библиотеку?', 'wp-file-manager'); ?></th>
<td>
...
<p style="color:#F00" class="description mb15"><?php _e('После включения этой функции все файлы будут отправлены в библиотеку.', 'wp-file-manager'); ?>
</p>
</td>
</tr>
</table>
